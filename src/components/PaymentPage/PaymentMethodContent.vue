...
export default {
  ...
  mounted() {
    ...
    // Extracting the forwarded data from the query parameters
    this.fullName = route.query.fullName || "";
    this.telephone = route.query.telephone || "";
    this.email = route.query.email || "";
    this.address = route.query.address || "";
    this.passengerFullNames = route.query.passengerFullNames
      ? JSON.parse(route.query.passengerFullNames)
      : [];
    this.passengerTelephones = route.query.passengerTelephones
      ? JSON.parse(route.query.passengerTelephones)
      : [];
    this.passengerTitles = route.query.passengerTitles
      ? JSON.parse(route.query.passengerTitles)
      : [];
    this.passengerAddresses = route.query.passengerAddresses
      ? JSON.parse(route.query.passengerAddresses)
      : [];
    this.departureId = route.query.departureId || "";
    this.destinationId = route.query.destinationId || "";
    this.passengerCount = Number(route.query.passengerCount) || 0;
